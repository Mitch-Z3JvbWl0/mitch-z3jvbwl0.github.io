...
- [x] Implement VLANs: Segregate traffic for different lab segments (Red Team, Vulnerable LAN, Server LAN).
...
- [x] Deploy Kali VM: Set up for penetration testing and security research.
